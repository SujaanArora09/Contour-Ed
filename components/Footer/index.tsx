...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke bg-[#092145] ">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          
          {/* Main Navigation */}
          <div className="flex flex-col flex-wrap items-stretch justify-evenly gap-20 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
            ...
            >
              <ul className="flex flex-col lg:flex-row  justify-between items-center w-full gap-8 mt-10">
                <li>
